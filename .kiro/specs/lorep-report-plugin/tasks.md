...
- [ ] 4. Checkpoint - Проверка тестов БД
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 5. Реализация Discord Webhook
  - [ ] 5.1 Создать DiscordWebhook сервис
    - Реализовать отправку embed сообщений через OkHttp
    - Обработать ошибки и отсутствие URL
    - _Requirements: 3.1, 3.2, 3.3_
  - [ ] 5.2 Написать property test для webhook payload
    - **Property 5: Webhook Payload Completeness**
    - **Validates: Requirements 3.1**

- [ ] 6. Реализация команд
  - [ ] 6.1 Создать ReportCommand (/report [ник] [причина])
